********************************
Airfoil with FFD Parametrization
********************************

The ``AirfoilFFD`` module within Blackbox provides various methods for running analysis and 
generating data with FFD Parametrization. Before starting to use this module, you will need the .dat file which 
...
Each subsection in this page will show how ``AirfoilFFD`` module can be used. It is highly recommended to go through options description first
and then proceed to other sub-sections. The `rae2822.dat` file used in the tutorials can be found in ``examples/airfoil_ffd/`` folder in the 
